  ...
  var a = (function () {
      var a =
          ...
          t(e)
            ...
            t(e)
              ...
              .selectorIndic.css({
                ...
                top: parseInt(
                  (t(e).data("colpick").height * (100 - a.b)) / 100,
                  10
                )
              });
        },
        p = function (a, e) {
          t(e)
            ...
            .hue.css(
              "top",
              parseInt(
                t(e).data("colpick").height -
                  (t(e).data("colpick").height * a.h) / 360,
                10
              )
            );
        },
        u = function (a, e) {
          t(e)
            .data("colpick")
            .currentColor.css("backgroundColor", "#" + d(a));
        },
        f = function (a, e) {
          t(e)
            .data("colpick")
            .newColor.css("backgroundColor", "#" + d(a));
        },
        h = function () {
          var a,
            e = t(this).parent().parent();
          this.parentNode.className.indexOf("_hex") > 0
            ? ((e.data("colpick").color = a = i(L(this.value))),
              l(a, e.get(0)),
              r(a, e.get(0)))
            : this.parentNode.className.indexOf("_hsb") > 0
            ? ((e.data("colpick").color = a = X({
          ...
          return (
            t.data.field.val(
              Math.max(
                ...
                Math.min(
                  t.data.max,
                  parseInt(t.data.val - t.pageY + t.data.y, 10)
                )
              )
            ),
            t.data.preview && h.apply(t.data.field.get(0), [!0]),
            !1
          );
        },
        m = function (a) {
          return (
            h.apply(a.data.field.get(0), [!0]),
            a.data.el.removeClass("colpick_slider").find("input").focus(),
            t(document).off("mouseup", m),
        ...
        b = function (a) {
          ...
          t(document).on("mouseup touchend", e, y),
            t(document).on("mousemove touchmove", e, x);
          var i =
            "touchstart" == a.type
          ...
          return (
            h.apply(
              e.cal
                ...
                .val(
                  parseInt(
                    (360 * (e.cal.data("colpick").height - (i - e.y))) /
                      e.cal.data("colpick").height,
                    10
                  )
                )
                .get(0),
              [e.cal.data("colpick").livePreview]
            ),
            !1
          );
        },
            ...
            h.apply(
              t.data.cal
                ...
                .val(
                  parseInt(
                    (360 *
                      (t.data.cal.data("colpick").height -
                        Math.max(
                          0,
                          Math.min(
                            t.data.cal.data("colpick").height,
        ...
        y = function (a) {
          return (
            l(a.data.cal.data("colpick").color, a.data.cal.get(0)),
            n(a.data.cal.data("colpick").color, a.data.cal.get(0)),
            t(document).off("mouseup touchend", y),
            t(document).off("mousemove touchmove", x),
            !1
          );
        },
        w = function (a) {
          ...
          (e.preview = e.cal.data("colpick").livePreview),
            t(document).on("mouseup touchend", e, I),
            t(document).on("mousemove touchmove", e, M);
          var i;
          return (
            "touchstart" == a.type
              ? ((pageX = a.originalEvent.changedTouches[0].pageX),
                (i = a.originalEvent.changedTouches[0].pageY))
              : ((pageX = a.pageX), (i = a.pageY)),
            h.apply(
              e.cal
                .data("colpick")
                .fields.eq(6)
                .val(
                  parseInt(
                    (100 * (e.cal.data("colpick").height - (i - e.pos.top))) /
                      e.cal.data("colpick").height,
                    10
                  )
                )
                ...
                .val(
                  parseInt(
                    (100 * (pageX - e.pos.left)) / e.cal.data("colpick").height,
                    10
                  )
                )
                .get(0),
          ...
          return (
            "touchmove" == t.type
              ? ((pageX = t.originalEvent.changedTouches[0].pageX),
                (a = t.originalEvent.changedTouches[0].pageY))
              : ((pageX = t.pageX), (a = t.pageY)),
            h.apply(
              t.data.cal
                .data("colpick")
                .fields.eq(6)
        ...
        I = function (a) {
          return (
            l(a.data.cal.data("colpick").color, a.data.cal.get(0)),
            n(a.data.cal.data("colpick").color, a.data.cal.get(0)),
            t(document).off("mouseup touchend", I),
        ...
        C = function () {
          ...
          (a.data("colpick").origColor = e),
            u(e, a.get(0)),
            a.data("colpick").onSubmit(e, d(e), c(e), a.data("colpick").el);
        },
        T = function (a) {
          a.stopPropagation();
        ...
        q = function (a) {
          0 !=
            a.data.cal
              .data("colpick")
              .onHide.apply(this, [a.data.cal.get(0)]) && a.data.cal.hide(),
            t("html").off("mousedown", q);
        },
        S = function () {
      ...
      return {
        init: function (c) {
          if (((c = t.extend({}, e, c || {})), "string" == typeof c.color))
            c.color = i(c.color);
          else if (
            void 0 != c.color.r &&
            void 0 != c.color.g &&
          ...
          return this.each(function () {
            if (!t(this).data("colpickId")) {
              ...
              o.addClass(
                "colpick_" +
                  e.layout +
                  (e.submit ? "" : " colpick_" + e.layout + "_ns")
              ),
                "light" != e.colorScheme &&
                  o.addClass("colpick_" + e.colorScheme),
                o.find("div.colpick_submit").html(e.submitText).click(C),
                (e.fields = o.find("input").change(h).blur(v).focus(g)),
                o
                ...
                (e.selector = o
                  ...
                  .on("mousedown touchstart", w)),
                (e.selectorIndic = e.selector.find(
                  "div.colpick_selector_outer"
                )),
                (e.el = this),
                (e.hue = o.find("div.colpick_hue_arrs")),
                (huebar = e.hue.parent());
              var d = navigator.userAgent.toLowerCase(),
                _ = "Microsoft Internet Explorer" === navigator.appName,
                m = _
                  ? parseFloat(d.match(/msie ([0-9]{1,}[\.0-9]{0,})/)[1])
                  : 0,
                x = _ && 10 > m,
                y = [
                  "#ff0000",
              ...
              o.find("div.colpick_hue").on("mousedown touchstart", b),
                (e.newColor = o.find("div.colpick_new_color")),
                (e.currentColor = o.find("div.colpick_current_color")),
                o.data("colpick", e),
                l(e.color, o.get(0)),
                r(e.color, o.get(0)),
                n(e.color, o.get(0)),
        ...
        hidePicker: function () {
          return this.each(function () {
            t(this).data("colpickId") &&
              t("#" + t(this).data("colpickId")).hide();
          });
        },
        setColor: function (a, e) {
          if (((e = "undefined" == typeof e ? 1 : e), "string" == typeof a))
            a = i(a);
          ...
          return this.each(function () {
            if (t(this).data("colpickId")) {
              ...
              (i.data("colpick").color = a),
                (i.data("colpick").origColor = a),
                l(a, i.get(0)),
                r(a, i.get(0)),
                n(a, i.get(0)),
                p(a, i.get(0)),
    ...
    c = function (t) {
      ...
      return { r: Math.round(a.r), g: Math.round(a.g), b: Math.round(a.b) };
    },
    l = function (a) {
